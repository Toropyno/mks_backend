DB_ERROR_CODES = {
    ...
    'object_categories_list_pkey_duplicate': 'Перечень Категорий Объектов с таким id уже существует!',
    ...
    'fias_aoid_key_duplicate': 'FIAS с таким AOID уже существует!',
    ...
    'coordinates_pkey_duplicate': 'Координаты с таким id уже существуют!',
