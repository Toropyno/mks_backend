DB_ERROR_CODES = {
    ...
    'organization_documents_doc_date_key_duplicate': 'Документы Организации с указанной датой уже существуют!',
    'organization_documents_doc_number_key_duplicate': 'Документы Организации с указанным номером уже существуют!',
    'organization_documents_doctypes_id_key_duplicate': 'Документы Организации с указанным Типом уже существуют!',
    'organization_documents_organizations_id_key_duplicate': 'Документы с указанной Организацией уже существуют!',
    'organization_documents_unique_duplicate': 'Документы Организации с указанными номером, датой, Типом Документа и '
                                               'Организацией уже существуют!',
    ...
    'organization_documents_doctypes_id_fkey': 'Указанного Типа Документов не существует!',
    'organization_documents_organizations_id_fkey': 'Указанной Организации не существует!',
    'organization_documents_idfilestorage_fkey': 'Указанного Файла не существует!',
