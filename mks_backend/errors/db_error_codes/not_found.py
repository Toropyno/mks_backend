NOT_FOUND_ERROR = {
    ...
    'military_unit_extension_nf': 'Указанного дополнительного описания в/ч не существует!',
    'participant_status_nf': 'Указанного статуса участника судебных споров не существует!',
    'work_trip_file_nf': 'Файл поездки не найден',
    'class_rank_nf': 'Указанный классный чин не существует!'
}
