def include_state_contracts(config):
    ...
    config.add_route('delete_contract', '/contract/{contract_id}', request_method='DELETE')
    config.add_route('edit_contract', '/contract/{contract_id}', request_method='PUT')
    config.add_route('get_contract', '/contract/{contract_id}', request_method='GET')
