...
class VisitedObjectController:
    ...
    def get_visited_objects_by_work_trip(self):
        work_trip_id, _ = self.get_work_trip_id_and_construction_id()
    ...
    def delete_visited_object(self):
        work_trip_id, construction_id = self.get_work_trip_id_and_construction_id()
    ...
    def get_work_trip_id_and_construction_id(self):
        return (
            int(self.request.matchdict.get('work_trip_id', -1)),
            int(self.request.matchdict.get('construction_id', -1))
        )
