...
class ObjectDocumentController:
    ...
    @view_config(route_name='get_object_documents', request_method='GET', renderer='json')
    ...
    @view_config(route_name='delete_object_document', request_method='DELETE', renderer='json')
