...
class ProtocolControllerSchema(colander.MappingSchema):
    protocol_num = colander.SchemaNode(colander.String(),
                                       ...
                                       validator=colander.Length(min=1,
                                                                 max=20,
                                                                 min_err='Недопустимый номер протокола',
                                                                 max_err='Недопустимый номер протокола'))
    protocol_date = colander.SchemaNode(colander.String(),
                                        name='protocolDate',
    ...
    protocol_name = colander.SchemaNode(colander.String(),
                                        ...
                                        validator=colander.Length(min=1,
                                                                  max=255,
                                                                 min_err='Недопустимое имя протокола',
                                                                 max_err='Недопустимое имя протокола'))
    note = colander.SchemaNode(colander.String(),
                               name='note',
                               validator=colander.Length(min=1,
                                                         max=2000,
                                                         min_err='Недопустимое примечание',
