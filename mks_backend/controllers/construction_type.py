...
from mks_backend.controllers.schemas.construction_type import ConstructionTypeSchema
from mks_backend.serializers.construction_type import ConstructionTypeSerializer
from mks_backend.services.construction_type import ConstructionTypeService
