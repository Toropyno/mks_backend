...
from mks_backend.controllers.schemas.military_rank import MilitaryRankSchema
from mks_backend.serializers.military_rank import MilitaryRankSerializer
from mks_backend.services.military_rank import MilitaryRankService
...
class MilitaryRankController:
    ...
    def add_military_rank(self):
        ...
        military_rank = self.service.convert_schema_to_object(military_rank_deserialized)
