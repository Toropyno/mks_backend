...
class SubcategoriesList(Base):
    ...
    construction_categories = relationship("Protocol", back_populates="subcategories_list", passive_deletes=True)
    construction_subcategories = relationship("Protocol", back_populates="subcategories_list", passive_deletes=True)
